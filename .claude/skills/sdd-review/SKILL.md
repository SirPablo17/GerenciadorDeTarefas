...
A revisão deve identificar inconsistências, riscos e oportunidades de melhoria para reduzir retrabalho a implementação.
...
* Funcionalidades descritas em apenas artefato
...
* Funcionalidades deveriam ser divididas em novos changes
* Dependências entre funcionalidades

Segerir possíveis quebras em capacidades menores.
...
* Riscos para manuntenção futura
